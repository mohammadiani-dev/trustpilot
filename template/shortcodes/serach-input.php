...
function trpi_search_input_shortcode(){
    ob_start();
    ?>
    <div class="trpi_search_buisiness">
        <input type="text" placeholder="جستجو در کسب و کار ها...">
...
add_shortcode("trpi_search_input" , "trpi_search_input_shortcode");