...
class date{
    ...
    public static function convert($format, $timestamp='', $none='', $time_zone='Asia/Tehran', $tr_num='fa')
    {
        ...
        for ($i=0; $i<$sl; $i++) {
            ...
            case'D':
            $out.=self::words(array('kh'=>$date[7]), ' ');
            break;

            case'f':
            $out.=self::words(array('ff'=>$j_m), ' ');
            break;
            ...
            case'l':
            $out.=self::words(array('rh'=>$date[7]), ' ');
            break;
            ...
            case'v':
            $out.=self::words(array('ss'=>($j_y%100)), ' ');
            break;

            case'V':
            $out.=self::words(array('ss'=>$j_y), ' ');
            break;
    ...
    public static function words($array, $mod='')
    {
